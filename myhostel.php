...
if((isset($_POST['stdId'])) && (isset($_POST['hstId'])))
{
  ...
  $hostelId = $_POST['hstId']; # Hostel id
  $studentId = $_POST['stdId']; # Student Id
...
{
  $hostelId2 = $_POST['hstId2']; # Hostel ID
  $studentId2 = $_POST['stdId2']; # Student ID
  # query database data
...
<body>
 ...
 <!-- jQuery code  -->
  <script type="text/javascript">
  	$(document).ready(function(){
  		$('#about_info').hide(); // hide the about section
