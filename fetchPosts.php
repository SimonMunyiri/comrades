      ...
      #number of likes are displayed as a subscript of the "like" text.
             ...
             if($getAccountDetailsNum != 0)
             {
              ...
              <div id="profile_header_container">
                ...
                <a href="<?php echo $postedPhoto; ?>">
                  <img src="<?php echo $postedPhoto; ?>" class="posted-photo" width="450" alt="IMG_COMRADES_<?php echo $postedPhoto; ?>"/>
                </a>
                    ...
                    <tr>
                      <td>
                        <?php
                            ...
                            # check whether the user has actually liked the post
                            # Fetch the person who liked the post
                            $row = mysqli_fetch_assoc($queryLikes);
                            # id of the user who liked the post
                            if ($queryLikesNum > 0)
                            {
                              $idOfUserWhoLikedPost = $row['friendEmail'];
                            }                           
                            
                           
                        ?>
                        <button type="button" style="width:20px;height:30px;background:transparent;border:none; margin-right: 5px; margin-left: 10px; cursor: pointer;"  id="l<?php echo $post_Id; ?>s">
                              <?php
                              # check whether the user has liked the post
                              if ($queryLikesNum > 0)
                              {
                                if ($idOfUserWhoLikedPost == $active_id)
                                {
                                  echo '<span class="fa fa-heart" style="font-size: 19px; color: red;"></span>';
                                }
                                
                              }
                              else 
                              {
                                echo '<span class="fa fa-heart" style="font-size: 18px; color: blue;"></span>';
                              }
        ...
        <script type="text/javascript">
          $(document).ready(function(){
           ...
           <?php
           # check whether the user has liked the post
           $queryLikesPost = mysqli_query($conn, "SELECT * FROM likes WHERE friendEmail='$active_id' AND post='$post_Id' ");

           if (mysqli_num_rows($queryLikesPost) > 0)
           {
                          ...
                          <button type="button"  style="height:30px;background:transparent;border:none;color:blue;" id="<?php echo $post_Id; ?>comment">
                            ...
                            <?php
                                ...
                                elseif($commentsNum>1000000 && $commentsNum<1000000000)
                                {
                                  ...
                                  echo '<b style="color:blue; margin-top: 12px;">Be the first one to comment.</b>';
                                }
