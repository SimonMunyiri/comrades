...
// Check whether the user has logged into 
// the database
if (empty($active_id))
{
      ...
      <tr>
        <td colspan="2">
          <form action="index.php" method="POST" enctype="multipart/form-data">
            <textarea name="description" placeholder="Add a text here..." style="width:400px;height:150px;border-radius:10px;border:1px dotted purple;padding:10px;"></textarea>
